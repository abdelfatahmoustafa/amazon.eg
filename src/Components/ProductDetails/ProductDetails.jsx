                ...
                <div className="my-5 pt-5">
                  ...
                  <div className="ms-2">
                    ...
                    <div>
                      <p className="pe-3">
                        ...
                        <span className="zonoffblackcolor">
                          {proDetails?.ratingsAverage}
                        </span>
                      </p>
                    </div>
                    <div className="d-flex">
                      <div className="zonoffblackbg w-25 text-center p-1 rounded-3">
                    ...
                    {proDetails.priceAfterDiscount ? (
                      <div className="bg-danger text-white w-25 mt-2 text-center rounded-1 p-2">
                        On Sale
                      </div>
                    ) : (
                      ""
                    ...
                    <div className="d-flex">
                      <p className="zonoffblackcolor pe-1">Price:</p>{" "}
                      {proDetails.priceAfterDiscount ? (
                        <div>
                          ...
                          <span className="text-success">
                            {proDetails.priceAfterDiscount} EGP
                          </span>
                        </div>
                      ) : (
                        <span className="text-success">
                    ...
                    <div>
                      <p className="fs-5">{proDetails?.description}</p>
                    </div>
                    {loading2 ? (
                      ...
                      <button
                        onClick={() => {
                          addProduct(proDetails.id);
                        }}
                        className="w-100 zonblackcolor zonyellowbg btn btn-warning"
                      >
                        + Add to Cart
                      </button>
                    )}
