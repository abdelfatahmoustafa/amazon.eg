...
import wishlist_empty from "../../images/wishlist-empty.png";
                ...
                {Wishlist.length == 0 ? (
                  <>
                    <div className="w-50 mx-auto">
                      <img src={wishlist_empty} className="w-100" alt="" />
                    </div>
                                ...
                                <div className="d-flex">
                                  <div>
                                    <button
                                      ...
                                      className="zonblackcolor zonyellowbg btn btn-warning"
                                    >
                                      + Add to Cart
                                    </button>
                                  </div>
