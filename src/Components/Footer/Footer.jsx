...
import logo_amazon_navbar from "../../images/logo-amazon-navbar.png";
      ...
      <footer>
        <div className="zononblackkbg py-2 shadow-lg">
          <div className="col-sm-12">
            <div className="w-100">
              <Link
                className="nav-link text-light texthover text-center"
                to="/home"
              >
                Back To Home
              </Link>
        ...
        <div className="zonoffblackbg py-3 shadow-lg">
          <div className="col-sm-12">
            <div className="navwidth mx-auto py-2">
              <Link to="home">
                <img src={logo_amazon_navbar} className="w-100" alt="" />
              </Link>
            </div>
          </div>
        </div>
