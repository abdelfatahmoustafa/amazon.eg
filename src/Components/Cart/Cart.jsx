  ...
  return (
    <>
      {isloading ? (
        ...
        <section>
          {/* <div className="col-xxl-12 zononblackkbg shadow-lg p-1 text-center">
            <Link
            ...
            <div className="row">
              <div className="col-xl-12">
                <div className="d-flex justify-content-between">
                  ...
                  <p className="fs-3">
                    Total Price:{" "}
                    <span>{TotalPrice.payload?.data?.totalCartPrice}</span>
                    <span className="text-success ps-1">EGP</span>
                  </p>
                </div>
                          ...
                          <div className="d-flex justify-content-between">
                            <div className="row">
                              ...
                              <div className="col-sm-12 col-lg-7">
                                ...
                                />
                                <div>
                                  <span className="mt-5  pe-1">Brand:</span>
                                ...
                                <div className="d-flex">
                                  ...
                                  <div className="d-flex ps-1">
                                    ...
                                    <button
                                      onClick={() => {
                                        addProduct(el.product.id);
                                      }}
                                      className=" btn"
                                    >
                                      <span>
                                        <i className="fa-sharp fa-solid fa-clipboard-list pe-1"></i>
                                      </span>
                                      Add to Wishlist?
                                    </button>
                                  </div>
            ...
            <div className="d-flex justify-content-around">
              ...
              <div className="w-25 py-5 mx-auto">
                <Link
                  ...
                  to={`/CheckOutVisa/${id}`}
                >
                  <button className="zonyellowbg btn w-100 btn-warning">
                    <i className="fa-brands fa-cc-visa"></i> Online Payment
                  </button>
                </Link>
              </div>
            </div>
